"""YelpReviewGym - Staff Training Platform

Train your staff using insights from Yelp reviews with AI-powered feedback.
"""
...
def main():
    ...
    with col_scenarios:
        ...
        can_generate = (
            ...
            and len(st.session_state.insights.pains) > 0
        )
        ...
        if st.button(
            ...
            with st.spinner("Generating training scenarios..."):
                try:
                    ...
                    st.session_state.scenarios = []
                    st.session_state.scenarios_raw = str(e)
        ...
        if scenarios:
            ...
            if can_generate:
                ...
                if st.session_state.insights is None:
                    st.warning("⚠️ Complete Step 1 first (Analyze Business)")
                elif not st.session_state.insights.pains:
                    st.warning("⚠️ No pain points found. Try analyzing again or try a different business with more reviews.")
                else:
